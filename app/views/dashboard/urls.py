...
urlpatterns = [
    ...
    url(r'^change_graph$', dashboard_views.change_graph, name='dashboard_change_graph'),
    url(r'^new$', dashboard_views.new_dashboard, name='dashboard_new'),
    url(r'^(?P<dashboard_id>[0-9]+)/edit$', dashboard_views.edit_dashboard, name="dashboard_edit"),
    url(r'^(?P<dashboard_id>[0-9]+)$', dashboard_views.dashboard_view, name="dashboard_view"),
]
